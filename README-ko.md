...
README는 의도적으로 landing page 역할만 합니다. 세부 계약은 아래 문서들이 소유합니다.
...
| Helper CLI 계약 | [bin/README.md](bin/README.md) |

Helper lifecycle 계약의 SSoT는 `bin/`과 install script입니다. README에 세부 내용을 복사하지 말고, 소유 문서나 script를 직접 수정하세요.
